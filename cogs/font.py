...
class Font(commands.Cog):
    def __init__(self, bot):
        self.font_list = ['3-d', '3x5', '5lineoblique ', 'acrobatic', 'alligator', 'alligator2', 'alphabet', 'avatar',
                          ...
                          'coinstak', 'colossal', 'computer', 'contessa', 'contrast', 'cosmic', 'cosmike', 'cyberlarge',
                          'cybermedium', 'cybersmall', 'cygnet', 'diamond', 'digital', 'doh', 'doom', 'dotmatrix',
                          'drpepper', 'eftichess', 'eftifont', 'eftipiti', 'eftirobot', 'eftitalic ', 'eftiwall',
                          'eftiwater', 'epic', 'fender', 'fourtops', 'fuzzy', 'goofy', 'gothic', 'graffiti',
                          'hollywood', 'invita', 'isometric1', 'isometric2', 'isometric3', 'isometric4', 'italic',
                          'jazmine', 'kban', 'larry3d', 'lcd', 'lean', 'letters', 'linux', 'lockergnome', 'madrid',
                          'marquee', 'maxfour', 'mike', 'mini', 'mirror', 'nancyj-fancy', 'nancyj-underlined', 'nancyj',
                          'nipples', 'o8', 'ogre', 'pawp', 'peaks', 'pebbles', 'pepper', 'poison', 'puffy', 'pyramid',
                          'rectangles', 'relief', 'relief2', 'rev', 'roman', 'rot13', 'rounded', 'rowancap', 'rozzo',
                          'sblood', 'script', 'serifcap', 'shadow', 'short', 'slant', 'slide', 'slscript', 'small',
                          'smisome1', 'smkeyboard', 'smscript', 'smshadow', 'smslant', 'smtengwar', 'speed',
                          'stampatello', 'standard', 'starwars', 'stellar', 'stop', 'straight', 'swan', 'tanja',
                          'tengwar', 'term', 'thick', 'thin', 'threepoint', 'ticks', 'ticksslant', 'tinker-toy',
                          'tombstone', 'trek', 'twopoint', 'univers', 'usaflag', 'weird']
        self.bot = bot
    ...
    async def font(self, ctx, keyword=None, font=None):
        ...
        font_keyword = self.bot.language(self.bot, lang, "FONT_AND_KEYWORD", font=font, keyword=keyword)
        text_discord = "```\n" + text_ascii + "\n\n" + font_keyword + "```"
